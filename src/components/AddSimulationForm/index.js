...
const AddSimulationForm = ({ t, disable, fields, updateField }) => (
  <CForm>
    <CRow>
      ...
      <CCol sm="4">
        <CInput
          ...
          maxLength="50"
        />
        <CFormText hidden={!fields.macPrefix.error} color={fields.macPrefix.error ? 'danger' : ''}>
      ...
      <CLabel className="mb-2" sm="2" col htmlFor="concurrentDevices">
        {t('common.concurrent_devices')}
        <RequiredAsterisk />
      </CLabel>
      <CCol sm="4">
        <CInput
          id="concurrentDevices"
          type="number"
          required
          value={fields.concurrentDevices.value}
          onChange={updateField}
          invalid={
            fields.concurrentDevices.value < fields.concurrentDevices.min ||
            fields.concurrentDevices.value > fields.concurrentDevices.max
          }
          disabled={disable}
          pattern="[0-9]*"
          style={{ width: '100px' }}
        ...
        <CInvalidFeedback>
          {t('common.min_max', {
            min: fields.concurrentDevices.min,
            max: fields.concurrentDevices.max,
          })}
        </CInvalidFeedback>
      </CCol>
